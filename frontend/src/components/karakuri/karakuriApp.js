...
// ✅ Updated import paths based on your structure
...
function KarakuriApp() {
  return (
    <>
      {/* Navbar for internal navigation */}
      <nav
      ...
      >
        <div className="container">
          <Link
            className="navbar-brand fw-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600"
            to="/karakuri"
            style={{
              backgroundImage: "linear-gradient(to right, #2563eb, #4f46e5)",
              WebkitBackgroundClip: "text",
          ...
          <ul className="navbar-nav ms-auto">
            <li className="nav-item">
              <Link className="nav-link" to="/karakuri/createpart1">
                Create Part
              </Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link" to="/karakuri/scanpart1">
                Scan Part
              </Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link" to="/karakuri/listpart1">
                List Parts
              </Link>
            </li>
            <li className="nav-item">
              <Link className="nav-link" to="/karakuri/editpart1">
                Edit Part
              </Link>
            </li>
          </ul>
      ...
      {/* Internal Routes */}
      <Routes>
      <Route path="/" element={<KarakuriMain />} />
